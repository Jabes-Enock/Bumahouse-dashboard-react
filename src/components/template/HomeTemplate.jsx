      ...
      <div className="space-y-8 md:col-span-1">
        <div className="space-y-4 text-blue-500">
          ...
          <div className="text-3xl ">
            toda a sua aplicação com o AdminSystem
          </div>
        </div>
        <div className="">
          <button
            type="button"
            class="w-52 focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900"
