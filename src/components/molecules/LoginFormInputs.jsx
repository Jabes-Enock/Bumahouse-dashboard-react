...
const LoginFormInputs = () => {
    ...
    const [requestStateEmailAndPassword, setRequestStateEmailAndPassword] = useState(false)
    ...
    return (
        <div className="p-10 h-full">
            ...
            <div className="mb-6">
                ...
                />
                { error && <div className='w-full mt-6 inline-flex justify-center'><AlertMessage message={error} /></div>} 
            </div>
